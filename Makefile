...
OBJECTS = bin/main.o bin/modular_arithmetic.o bin/elliptic_curve.o bin/rand.o
EXEC1 = main.out
...
bin/main.o : src/main.cpp inc/functions.hpp inc/hash.hpp inc/modular_arithmetic.hpp inc/elliptic_curve.hpp $(BLOCK)
	$(CC) $< $(CFLAGS) -c -o $@
